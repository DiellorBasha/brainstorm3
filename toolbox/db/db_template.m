...
switch lower(structureName)
    ...
    case 'manifoldmat'
        template = struct(...
              ...
              'Extrinsic',     [], ...
              'Gauge',         [], ...
              'DEC',           [], ...   % 1x2 per-hemi struct: discrete exterior calculus operators of the manifold -- d0 [E x V], d1 [F x E] (exterior derivatives); h0 [V x V], h1 [E x E], h2 [F x F] (Hodge stars); sharp [3F x E] (musical isomorphism #, 1-form->face vector). Geometry-derived primitives; toolbox/differential composes them (grad f = sharp*d0*f, etc.). Also carries GlobalVertices/GlobalFaces like the other facet groups.
              'Provenance',    []);
