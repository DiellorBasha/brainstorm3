...
%% ===== FILE FILTERS =====
    case 'FileFilters'
        switch lower(varargin{2})
            ...
            case 'pet'
                argout1 = {...
                    {'.img'},          'PET: Analyze (*.img/*.hdr)',           'Analyze'; ...
                    {'.ima'},          'PET: BrainVISA GIS (*.ima/*.dim)',     'GIS'; ...
                    {'.v','.i'},       'PET: ECAT (*.v/*.i)',                  'ECAT'; ...
                    {'.mgh','.mgz'},   'PET: MGH (*.mgh,*.mgz)',               'MGH'; ...
                    {'.mnc', '.mni'},  'PET: MNI (*.mnc,*.mni)',               'MINC'; ...
                    {'.nii','.gz'},    'PET: NIfTI-1 (*.nii;*.nii.gz)',        'Nifti1'; ...
                    {'_subjectimage'}, 'PET: Brainstorm (*subjectimage*.mat)', 'BST'; ...
                    {'*'},             'PET: DICOM (SPM converter)',           'DICOM-SPM'; ...
                    {'.mri', '.fif', '.img', '.ima', '.nii', '.mgh', '.mgz', '.mnc', '.mni', '.gz', '_subjectimage'}, 'All PET files (subject space)', 'ALL'; ...
                   };
            case 'petout'
                argout1 = {...
                    {'.img'}, 'PET: Analyze (*.img/*.hdr)',         'Analyze'; ...
                    {'.ima'}, 'PET: BrainVISA GIS (*.ima/*.dim)',   'GIS'; ...
                    {'.mri'}, 'PET: CTF (*.mri)',                   'CTF'; ...
                    {'.mat'}, 'PET: FieldTrip (*.mat)',             'FT-MRI'; ...
                    {'.nii'}, 'PET: NIfTI-1 (*.nii)',               'Nifti1'...
                   };
            case 'anatin'
                argout1 = {...
