...
function OutputFiles = Run(sProcess, sInputs) %#ok<DEFNU>
    ...
    for iInput = 1:nInputs
        ...
        % ===== APPLY EIGENMODE INVERSE =====
        % ĉ(t) = M̃ · d(t) — direct sensor-to-eigenmode mapping
        ...
        if ismember(OutputType, {'sources', 'both'})
            % Build a vertex-space imaging kernel:
            % ImagingKernel_vertex = Phi · M̃  [nVertices × nGoodChannels]
            % So that: u(t) = ImagingKernel_vertex · d(t) = Phi · ĉ(t)
